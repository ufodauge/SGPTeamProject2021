-- System
Const.define('SYS_WIDTH', 800)
Const.define('SYS_HEIGHT', 600)

-- Fonts
Const.define('FONT_REGULAR', Data.Font.regular)
Const.define('FONT_DEBUG', Data.Font.debug)
Const.define('FONT_TITLE', Data.Font.title)

Const.define('FONTS_LIST', {FONT_REGULAR, FONT_DEBUG, FONT_TITLE})

-- debug
Const.define('DEBUG_MENU_X', 20)
Const.define('DEBUG_MENU_Y', 10)
Const.define('DEBUG_INFO_X', 20)
Const.define('DEBUG_INFO_Y', 400)
Const.define('DEBUG_FRAMECOUNT_X', SYS_WIDTH - 200)
Const.define('DEBUG_FRAMECOUNT_Y', 5)
Const.define('DEBUG_FREECAMERA_X', SYS_WIDTH - 200)
Const.define('DEBUG_FREECAMERA_Y', 25)
...
Const.define('TEXT_PRINT_TYPE_UPPER_LEFT', 1)
